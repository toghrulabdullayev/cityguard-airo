    ...
    <div className="relative min-h-screen bg-[#04040A] text-[#7E7F94] overflow-x-hidden pt-4 pb-12 cyber-grid">
      ...
      <header className="max-w-[1152px] mx-auto px-6 h-20 flex items-center justify-between border-b border-neutral-tertiary-medium">
        ...
        <nav className="hidden md:flex items-center gap-8 text-[13px] font-audiowide tracking-wider uppercase text-heading select-none">
          ...
          <a href="#features" className="hover:text-brand transition-colors text-body-subtle hover:text-heading">Anomaly Engine</a>
      ...
      <section className="relative max-w-[1152px] mx-auto px-6 pt-16 md:pt-24 pb-16 flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-brand-softer border border-brand-medium/40 text-brand text-[11px] font-mono uppercase tracking-[2px] mb-6 animate-pulse leading-none select-none">
          ...
          Smart Grid Monitor Active // v2.4
        </div>
        ...
        <h1 className="font-audiowide font-bold text-4xl sm:text-5xl md:text-6xl tracking-wider text-heading uppercase max-w-4xl leading-[1.1] mb-6">
          AI-Powered Threat Detection for <span className="text-brand animate-glitch">Smart City</span> Payments
        </h1>

        <p className="font-sans text-lg text-body max-w-2xl leading-relaxed mb-10 select-none">
          Protect parking meters, transit kiosks, municipal portals, and urban payment infrastructure 
          from sophisticated cyber attacks. Real-time behavioral analysis in under 42ms.
        </p>
          ...
          <div className="bg-neutral-primary-soft/90 p-4 font-mono text-[11px] text-left text-brand/80 select-none">
            <div className="flex items-center justify-between border-b border-default pb-2 mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-heading font-bold uppercase font-audiowide tracking-wider">Smart City Gateway // Feed</span>
              </div>
              <div className="text-[10px] text-body-subtle">PROBE SECURE // MUNICIPAL-NODE 0.0.0.0:3000</div>
            </div>
            <div className="space-y-1.5 opacity-90">
              <p className="text-body-subtle">[08:24:11] INITIALIZING DEEP LEARNING SEQUENCE EVALUATION...</p>
              <p className="text-[#00E676]">[08:24:12] PASS: Citizen 0x93FA: Parking meter payment within normal dwell time. (Risk Score: 11 / Green)</p>
              <p className="text-[#00E676]">[08:24:13] PASS: Transit card 0x11E8: $2.30 metro fare — baseline signature verified. (Risk Score: 04 / Green)</p>
              <p className="text-danger border-danger/30 font-bold">[08:24:14] WARN: Citizen 0x82AB: Location anomaly. Same card scanned at Downtown and Riverside stations within 2 minutes. Impossible travel detected.</p>
              <p className="text-danger font-bold">[08:24:14] HALT: Card 0x82AB BLOCK TRIGGERED. AI terminated transaction before fare deduction. (Risk score: 98 // Red)</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="stats" className="max-w-[1152px] mx-auto px-6 py-24 border-t border-default-medium">
        <div className="text-center mb-16 select-none">
          <span className="font-mono text-[12px] tracking-[4px] uppercase text-brand">Vulnerability Assessment</span>
          <h2 className="font-audiowide font-bold text-3xl md:text-4xl text-heading uppercase tracking-wider mt-2">
            The Cost of Vulnerable Infrastructure
          </h2>
          <p className="max-w-xl mx-auto mt-4 text-sm text-body">
            Legacy urban payment processors rely on static rules, creating massive windows for card skimming, credential abuse, and coordinated attacks across city assets.
          </p>
        </div>
      ...
      <section id="features" className="max-w-[1152px] mx-auto px-6 py-24 border-t border-default-medium bg-neutral-secondary-soft/30">
        <div className="text-center mb-16 select-none">
          <span className="font-mono text-[12px] tracking-[4px] uppercase text-brand">Cyber Defense Layers</span>
          <h2 className="font-audiowide font-bold text-3xl md:text-4xl text-heading uppercase tracking-wider mt-2">
            AI Protection Pipeline
          </h2>
          <p className="max-w-xl mx-auto mt-4 text-sm text-body">
            We intercept urban cyber attacks across four specialized systems, operating in tandem at extreme speed across the entire smart city grid.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 select-none">
            ...
            <h2 className="font-audiowide font-bold text-3xl text-heading uppercase tracking-wider mt-2 mb-4">
              Inspect A Live Payment Probe
            </h2>
            <p className="text-sm text-body leading-relaxed mb-6">
              Push a simulated urban payment transaction through CityGuard's AI evaluator. Watch it analyze geolocation patterns, device handshake status, and temporal sequences to issue a real-time risk score in milliseconds.
            </p>

            <div className="space-y-4 border border-default p-4 bg-neutral-primary-soft clip-card">
              <div className="flex items-center gap-3">
                <span className="text-xs font-mono font-bold uppercase text-heading">DETECTOR CONTROL MODULE:</span>
              </div>
              ...
              >
                {probing ? (
                  <>
                    ...
                    Processing Payment Signal...
                  </>
                ) : (
                  <>
                    <Cpu className="w-4 h-4" />
                    Inject Payment Probe
                  </>
                )}
              </button>
            </div>
          ...
          <div className="lg:col-span-7 bg-neutral-primary-soft border border-default p-6 clip-card min-h-[300px] flex flex-col justify-between font-mono text-xs text-body relative">
            <div className="absolute top-3 right-4 flex items-center gap-2 select-none">
              ...
              <span className="text-[10px] text-brand uppercase font-bold text-xs">CITY-NODE READINESS: OK</span>
            </div>

            <div>
              <div className="border-b border-default pb-2 mb-4 flex items-center gap-2">
                <Terminal className="w-4 h-4 text-brand" />
                <span className="font-audiowide uppercase tracking-wider text-[12px] text-heading">Payment Inspector Payload</span>
              </div>
              ...
              {!probedTx && !probing ? (
                <div className="h-44 flex flex-col items-center justify-center text-center text-body-subtle border border-dashed border-default-strong">
                  ...
                  <p>Awaiting payment probe stimulus...</p>
                  <p className="text-[10px] font-mono mt-1">Press "Inject Payment Probe" on the control module</p>
                </div>
              ) : probing ? (
                <div className="h-44 flex flex-col items-center justify-center text-center text-brand">
                  ...
                  <p className="animate-pulse">SCANNING PAYMENT TERMINAL HEADERS...</p>
                  <p className="text-[10px] text-body-subtle leading-loose">Evaluating citizen behavior vectors against smart city grid</p>
                </div>
              ) : probedTx ? (
                <div className="space-y-3 font-mono text-[11px] leading-relaxed">
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 leading-none">
                    <p className="p-2 border border-default bg-neutral-secondary-soft">
                      <span className="block text-[9px] text-body-subtle mb-1">PAYMENT ID</span>
                      <span className="text-heading font-medium">{probedTx.id}</span>
                    </p>
                    <p className="p-2 border border-default bg-neutral-secondary-soft">
                      <span className="block text-[9px] text-body-subtle mb-1">AMOUNT (AZN)</span>
                      <span className="text-heading font-medium">{probedTx.amount.toFixed(2)} ₼</span>
                    </p>
                    <p className="p-2 border border-default bg-neutral-secondary-soft">
                      <span className="block text-[9px] text-body-subtle mb-1">PAYMENT POINT</span>
                  ...
                  <div className="p-3 border border-default bg-neutral-secondary-medium">
                    <div className="flex justify-between items-center mb-2 border-b border-default pb-1 leading-none">
                      <span className="text-[10px] text-body-subtle">RISK ASSESSMENT</span>
                      <div className="flex items-center gap-2">
                    ...
                    <div className="flex justify-between items-center border-b border-default pb-1 mb-2 leading-none">
                      ...
                      <span className={`font-audiowide text-[11px] px-2 py-0.5 rounded-none font-bold uppercase ${
                        ...
                        {probedTx.status === 'Flagged' ? 'PAYMENT HALTED' :
      ...
      <section id="comparison" className="max-w-[1152px] mx-auto px-6 py-24 border-t border-default-medium">
        <div className="text-center mb-16 select-none">
          <span className="font-mono text-[12px] tracking-[4px] uppercase text-brand">Benchmark Analysis</span>
          <h2 className="font-audiowide font-bold text-3xl md:text-4xl text-heading uppercase tracking-wider mt-2">
            Industry Comparison
          </h2>
          <p className="max-w-xl mx-auto mt-4 text-sm text-body">
            Compare CityGuard's behavioral telemetry approach against traditional rule-based urban payment security models.
          </p>
        </div>
      ...
      <section className="bg-neutral-secondary-soft border-t border-b border-default-medium py-10 select-none">
        <div className="max-w-[1152px] mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            ...
            <div className="text-[10px] font-mono uppercase tracking-wider text-body-subtle mt-1">Detection precision score</div>
          </div>
          <div>
            <div className="font-audiowide text-brand text-2xl font-bold tracking-wider">0.85 recall</div>
            <div className="text-[10px] font-mono uppercase tracking-wider text-body-subtle mt-1">Incident capture rate</div>
          </div>
          <div>
            <div className="font-audiowide text-[#00E676] text-2xl font-bold tracking-wider">&lt; 42ms</div>
            <div className="text-[10px] font-mono uppercase tracking-wider text-body-subtle mt-1">Payment evaluation speed</div>
          </div>
          <div>
            <div className="font-audiowide text-brand text-2xl font-bold tracking-wider">~3.2%</div>
            <div className="text-[10px] font-mono uppercase tracking-wider text-body-subtle mt-1">False Positive Rate</div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1152px] mx-auto px-6 py-24 text-center select-none">
        <div className="max-w-2xl mx-auto border border-brand bg-brand-softer/10 p-12 clip-card shadow-[0_0_20px_rgba(84,234,253,0.05)] relative overflow-hidden">
          ...
          <h2 className="font-audiowide font-bold text-3xl text-heading tracking-wider uppercase mb-4">
            Secure Your City's Payments
          </h2>
          <p className="font-sans text-sm text-body leading-relaxed mb-8">
            Stop reactive recovery. Connect your municipal payment telemetry pipelines today and instantly monitor abnormal behavior across parking, transit, utilities, and city services.
          </p>
          <button 
            onClick={onEnterTerminal}
      ...
      <footer className="max-w-[1152px] mx-auto px-6 pt-12 border-t border-default text-center text-xs text-body-subtle font-mono">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <p>© 2026 CityGuard — Smart City Cyber Threat Detection Systems.</p>
          <div className="flex gap-6 uppercase text-[10px] tracking-wider font-audiowide">
            <a href="#stats" className="hover:text-brand transition-colors">Threat Reports</a>
            <a href="#features" className="hover:text-brand transition-colors">Defense Matrix</a>
            <span className="text-body-subtle/30">|</span>
            <span className="text-[#00E676]">CITY NODE // LIVE</span>
          </div>
        </div>
      </footer>
    </div>
